...
function Others() {
    const [isOthersDropOpen, setOthersDropOpen] = useState(false);
    const toggleOthersDrop = (e)=>{
        e.preventDefault();
        setOthersDropOpen(!isOthersDropOpen);
    }
  return <>
              ...
              <div className="card-body">
                <div className="dropdown no-arrow mb-4">
                  <button className="btn btn-secondary dropdown-toggle" type="button"
                      ...
                      aria-expanded="false" onClick={toggleOthersDrop}>
                      Dropdown (no arrow)
                  </button>
                  <div className={`dropdown-menu ${isOthersDropOpen?"show":""}`} aria-labelledby="dropdownMenuButton">
                    <a className="dropdown-item" href="#" onClick={toggleOthersDrop}>Action</a>
                    <a className="dropdown-item" href="#" onClick={toggleOthersDrop}>Another action</a>
                    <a className="dropdown-item" href="#" onClick={toggleOthersDrop}>Something else here</a>
                  </div>
                </div>
